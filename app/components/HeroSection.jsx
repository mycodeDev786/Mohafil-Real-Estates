...
export default function HeroSection() {
  ...
  return (
    <section
      dir={isRTL ? "rtl" : "ltr"}
      className="relative h-screen w-full overflow-hidden bg-white text-white"
    >
      ...
      <div className="relative z-20 flex flex-col justify-center items-center h-full text-center px-6">
        ...
        {/* Search Bar */}
        <div className="mt-8 w-full max-w-4xl bg-white rounded-lg shadow-lg p-4 flex flex-col md:flex-row gap-4 items-center text-black">
          <input
            type="text"
